...
test_expect_success XATTR 'setxattr with wild offset is rejected' '
	touch export/xtestfile &&
        test_must_fail $PATH_DIODCLI bug-setxattr-offsetcheck \
